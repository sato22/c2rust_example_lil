...
pub type lil_write_callback_proc_t
    =
    Option<unsafe extern "C" fn(_: lil_t, _: *const libc::c_char) -> ()>;
...
pub type lil_error_callback_proc_t
    =
    Option<unsafe extern "C" fn(_: lil_t, _: size_t, _: *const libc::c_char)
               -> ()>;
pub type lil_setvar_callback_proc_t
    =
    Option<unsafe extern "C" fn(_: lil_t, _: *const libc::c_char,
                                _: *mut lil_value_t) -> libc::c_int>;
...
unsafe extern "C" fn hm_hash(mut key: *const libc::c_char) -> libc::c_ulong {
    ...
    loop  {
        ...
        hash =
            (hash <<
                 5 as
                     libc::c_int).wrapping_add(hash).wrapping_add(c as
                                                                      libc::c_ulong)
    }
    return hash;
}
unsafe extern "C" fn hm_init(mut hm: *mut hashmap_t) {
    memset(hm as *mut libc::c_void, 0 as libc::c_int,
           ::std::mem::size_of::<hashmap_t>() as libc::c_ulong);
}
...
unsafe extern "C" fn hm_put(mut hm: *mut hashmap_t,
    ...
    (*cell).e =
        realloc((*cell).e as *mut libc::c_void,
                (::std::mem::size_of::<hashentry_t>() as
                     libc::c_ulong).wrapping_mul((*cell).c.wrapping_add(1 as
                                                                            libc::c_int
                                                                            as
                                                                            libc::c_ulong)))
            as *mut hashentry_t;
...
unsafe extern "C" fn alloc_value_len(mut str: *const libc::c_char,
                                     mut len: size_t) -> lil_value_t {
    let mut val: lil_value_t =
        calloc(1 as libc::c_int as libc::c_ulong,
               ::std::mem::size_of::<_lil_value_t>() as libc::c_ulong) as
            lil_value_t;
    ...
    if !str.is_null() {
        ...
        memcpy((*val).d as *mut libc::c_void, str as *const libc::c_void,
               len);
...
unsafe extern "C" fn alloc_value(mut str: *const libc::c_char)
 -> lil_value_t {
...
pub unsafe extern "C" fn lil_clone_value(mut src: lil_value_t)
 -> lil_value_t {
    ...
    if (*src).l != 0 {
        ...
        memcpy((*val).d as *mut libc::c_void, (*src).d as *const libc::c_void,
               (*val).l.wrapping_add(1 as libc::c_int as libc::c_ulong));
    } else { (*val).d = 0 as *mut libc::c_char }
    return val;
}
#[no_mangle]
pub unsafe extern "C" fn lil_append_char(mut val: lil_value_t,
 ...
 -> libc::c_int {
    let mut new: *mut libc::c_char =
        realloc((*val).d as *mut libc::c_void,
                (*val).l.wrapping_add(2 as libc::c_int as libc::c_ulong)) as
            *mut libc::c_char;
...
pub unsafe extern "C" fn lil_append_string_len(mut val: lil_value_t,
 ...
 -> libc::c_int {
    ...
    new =
        realloc((*val).d as *mut libc::c_void,
                (*val).l.wrapping_add(len).wrapping_add(1 as libc::c_int as
                                                            libc::c_ulong)) as
            *mut libc::c_char;
    if new.is_null() { return 0 as libc::c_int }
    memcpy(new.offset((*val).l as isize) as *mut libc::c_void,
...
pub unsafe extern "C" fn lil_append_val(mut val: lil_value_t,
                                        mut v: lil_value_t) -> libc::c_int {
    let mut new: *mut libc::c_char = 0 as *mut libc::c_char;
    if v.is_null() || (*v).l == 0 { return 1 as libc::c_int }
    new =
        realloc((*val).d as *mut libc::c_void,
                (*val).l.wrapping_add((*v).l).wrapping_add(1 as libc::c_int as
                                                               libc::c_ulong))
            as *mut libc::c_char;
    if new.is_null() { return 0 as libc::c_int }
    memcpy(new.offset((*val).l as isize) as *mut libc::c_void,
...
pub unsafe extern "C" fn lil_alloc_list() -> lil_list_t {
    ...
    list =
        calloc(1 as libc::c_int as libc::c_ulong,
               ::std::mem::size_of::<_lil_list_t>() as libc::c_ulong) as
            lil_list_t;
        ...
        let mut cap: size_t =
            if (*list).cap != 0 {
                (*list).cap.wrapping_add((*list).cap.wrapping_div(2 as
                                                                      ...
                                                                      as
                                                                      libc::c_ulong))
            } else { 32 as libc::c_int as libc::c_ulong };
        let mut nv: *mut lil_value_t =
            realloc((*list).v as *mut libc::c_void,
                    (::std::mem::size_of::<lil_value_t>() as
                         libc::c_ulong).wrapping_mul(cap)) as
                *mut lil_value_t;
...
unsafe extern "C" fn needs_escape(mut str: *const libc::c_char)
 -> libc::c_int {
    let mut i: size_t = 0;
    ...
    while *str.offset(i as isize) != 0 {
        if *(*__ctype_b_loc()).offset(*str.offset(i as isize) as libc::c_int
                                          as isize) as libc::c_int &
               _ISpunct as libc::c_int as libc::c_ushort as libc::c_int != 0
               ||
               *(*__ctype_b_loc()).offset(*str.offset(i as isize) as
...
pub unsafe extern "C" fn lil_list_to_value(mut list: lil_list_t,
 ...
 -> lil_value_t {
    ...
    i = 0 as libc::c_int as size_t;
    while i < (*list).c {
        let mut escape: libc::c_int =
            if do_escape != 0 {
                needs_escape(lil_to_string(*(*list).v.offset(i as isize)))
            } else { 0 as libc::c_int };
        if i != 0 { lil_append_char(val, ' ' as i32 as libc::c_char); }
        if escape != 0 {
...
pub unsafe extern "C" fn lil_alloc_env(mut parent: lil_env_t) -> lil_env_t {
    ...
    env =
        calloc(1 as libc::c_int as libc::c_ulong,
               ::std::mem::size_of::<_lil_env_t>() as libc::c_ulong) as
            lil_env_t;
    (*env).parent = parent;
    return env;
}
...
unsafe extern "C" fn find_cmd(mut lil: lil_t, mut name: *const libc::c_char)
 -> lil_func_t {
    return hm_get(&mut (*lil).cmdmap, name) as lil_func_t;
}
unsafe extern "C" fn add_func(mut lil: lil_t, mut name: *const libc::c_char)
 -> lil_func_t {
    ...
    cmd =
        calloc(1 as libc::c_int as libc::c_ulong,
               ::std::mem::size_of::<_lil_func_t>() as libc::c_ulong) as
            lil_func_t;
    (*cmd).name = strclone(name);
    ncmd =
        realloc((*lil).cmd as *mut libc::c_void,
                (::std::mem::size_of::<lil_func_t>() as
                     libc::c_ulong).wrapping_mul((*lil).cmds.wrapping_add(1 as
                                                                              libc::c_int
                                                                              as
                                                                              libc::c_ulong)))
            as *mut lil_func_t;
...
unsafe extern "C" fn del_func(mut lil: lil_t, mut cmd: lil_func_t) {
    ...
    while i < (*lil).cmds {
        ...
        *fresh9 =
            *(*lil).cmd.offset(i.wrapping_add(1 as libc::c_int as
                                                  libc::c_ulong) as isize);
        i = i.wrapping_add(1)
    };
}
...
pub unsafe extern "C" fn lil_register(mut lil: lil_t,
 ...
 -> libc::c_int {
    ...
    if cmd.is_null() { return 0 as libc::c_int }
    (*cmd).proc_0 = proc_0;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn lil_set_var(mut lil: lil_t,
        ...
        if (var.is_null() && env == (*lil).rootenv ||
            ...
            let mut r: libc::c_int =
                proc_0.expect("non-null function pointer")(lil, name,
                                                           &mut newval);
            if r < 0 as libc::c_int { return 0 as lil_var_t }
            if r != 0 { val = newval; freeval = 1 as libc::c_int }
        }
        if !var.is_null() {
    ...
    nvar =
        realloc((*env).var as *mut libc::c_void,
                (::std::mem::size_of::<lil_var_t>() as
                     libc::c_ulong).wrapping_mul((*env).vars.wrapping_add(1 as
                                                                              libc::c_int
                                                                              as
                                                                              libc::c_ulong)))
            as *mut lil_var_t;
    ...
    *fresh10 =
        calloc(1 as libc::c_int as libc::c_ulong,
               ::std::mem::size_of::<_lil_var_t>() as libc::c_ulong) as
            lil_var_t;
...
pub unsafe extern "C" fn lil_new() -> lil_t {
    let mut lil: lil_t =
        calloc(1 as libc::c_int as libc::c_ulong,
               ::std::mem::size_of::<_lil_t>() as libc::c_ulong) as lil_t;
    (*lil).env = lil_alloc_env(0 as lil_env_t);
    (*lil).rootenv = (*lil).env;
    (*lil).empty = alloc_value(0 as *const libc::c_char);
    (*lil).dollarprefix =
        strclone(b"set \x00" as *const u8 as *const libc::c_char);
...
unsafe extern "C" fn skip_spaces(mut lil: lil_t) {
    while (*lil).head < (*lil).clen {
        if *(*lil).code.offset((*lil).head as isize) as libc::c_int ==
               '#' as i32 {
            if *(*lil).code.offset((*lil).head.wrapping_add(1 as libc::c_int
                                                                as
                                                                libc::c_ulong)
            ...
            if !(*(*__ctype_b_loc()).offset(*(*lil).code.offset((*lil).head as
                                                                    isize) as
                                                libc::c_int as isize) as
                     libc::c_int &
                     _ISspace as libc::c_int as libc::c_ushort as libc::c_int
...
unsafe extern "C" fn get_bracketpart(mut lil: lil_t) -> lil_value_t {
    ...
    while (*lil).head < (*lil).clen {
        if *(*lil).code.offset((*lil).head as isize) as libc::c_int ==
            ...
            if cnt == 0 as libc::c_int as libc::c_ulong { break ; }
            lil_append_char(cmd, ']' as i32 as libc::c_char);
        } else {
...
unsafe extern "C" fn next_word(mut lil: lil_t) -> lil_value_t {
    ...
    if *(*lil).code.offset((*lil).head as isize) as libc::c_int == '$' as i32
       {
        ...
        start = (*lil).head;
        while (*lil).head < (*lil).clen &&
                  *(*__ctype_b_loc()).offset(*(*lil).code.offset((*lil).head
                                                                     as isize)
    ...
    return if !val.is_null() {
               val
           } else { alloc_value(0 as *const libc::c_char) };
}
...
pub unsafe extern "C" fn lil_parse(mut lil: lil_t,
 ...
 -> lil_value_t {
    ...
    if funclevel != 0 { (*(*lil).env).breakrun = 0 as libc::c_int }
    while (*lil).head < (*lil).clen && (*lil).error == 0 {
        ...
        if (*words).c != 0 {
            let mut cmd: lil_func_t =
                find_cmd(lil,
                         lil_to_string(*(*words).v.offset(0 as libc::c_int as
                                                              isize)));
            if cmd.is_null() {
                    ...
                    if !(*lil).catcher.is_null() {
                        if (*lil).in_catcher < 16384 as libc::c_int {
                            ...
                            let mut msg: *mut libc::c_char =
                                malloc((**(*words).v.offset(0 as libc::c_int
                                                                as
                            ...
                            sprintf(msg,
                                    ...
                                    (**(*words).v.offset(0 as libc::c_int as
                                                             isize)).d);
                        ...
                        let mut msg_0: *mut libc::c_char =
                            malloc((**(*words).v.offset(0 as libc::c_int as
...
#[no_mangle]
pub unsafe extern "C" fn lil_callback(mut lil: lil_t, mut cb: libc::c_int,
                                      mut proc_0: lil_callback_proc_t) {
    if cb < 0 as libc::c_int || cb > 8 as libc::c_int { return }
...
pub unsafe extern "C" fn lil_error(mut lil: lil_t,
                                   ...
                                   mut pos: *mut size_t) -> libc::c_int {
    if (*lil).error == 0 { return 0 as libc::c_int }
    *msg = (*lil).err_msg;
    *pos = (*lil).err_head;
    (*lil).error = 0 as libc::c_int;
    return 1 as libc::c_int;
...
unsafe extern "C" fn ee_invalidpunct(mut ch: libc::c_int) -> libc::c_int {
    return (*(*__ctype_b_loc()).offset(ch as isize) as libc::c_int &
                ...
                ch != ')' as i32 && ch != '-' as i32 && ch != '+' as i32) as
               libc::c_int;
}
unsafe extern "C" fn ee_skip_spaces(mut ee: *mut expreval_t) {
    while (*ee).head < (*ee).len &&
              *(*__ctype_b_loc()).offset(*(*ee).code.offset((*ee).head as
                                                                isize) as
                                             libc::c_int as isize) as
                  libc::c_int &
                  _ISspace as libc::c_int as libc::c_ushort as libc::c_int !=
...
unsafe extern "C" fn ee_numeric_element(mut ee: *mut expreval_t) {
    ...
    while (*ee).head < (*ee).len {
        if *(*ee).code.offset((*ee).head as isize) as libc::c_int ==
               '.' as i32 {
            if (*ee).type_0 == 1 as libc::c_int { break ; }
            (*ee).type_0 = 1 as libc::c_int;
            (*ee).head = (*ee).head.wrapping_add(1)
        } else if *(*__ctype_b_loc()).offset(*(*ee).code.offset((*ee).head as
                                                                    isize) as
                                                 libc::c_int as isize) as
                      libc::c_int &
        ...
        if (*ee).type_0 == 0 as libc::c_int {
            (*ee).ival =
                (*ee).ival * 10 as libc::c_int as libc::c_long +
                    (*(*ee).code.offset((*ee).head as isize) as libc::c_int -
                         '0' as i32) as libc::c_long
        } else {
            fpart =
                fpart * 10 as libc::c_int as libc::c_long +
                    (*(*ee).code.offset((*ee).head as isize) as libc::c_int -
                         '0' as i32) as libc::c_long;
...
unsafe extern "C" fn ee_element(mut ee: *mut expreval_t) {
    if *(*__ctype_b_loc()).offset(*(*ee).code.offset((*ee).head as isize) as
                ...
                match (*ee).type_0 {
                    1 => {
                        ...
                        match (*ee).type_0 {
                            ...
                            0 => {
                                (*ee).dval =
                                    (*ee).ival as libc::c_double * odval;
                                (*ee).type_0 = 1 as libc::c_int
                            }
                            _ => { (*ee).error = 2 as libc::c_int }
                        }
...
unsafe extern "C" fn ee_shift(mut ee: *mut expreval_t) {
    ...
    while (*ee).head < (*ee).len && (*ee).error == 0 &&
              (*(*ee).code.offset((*ee).head as isize) as libc::c_int ==
                   '<' as i32 &&
                   *(*ee).code.offset((*ee).head.wrapping_add(1 as libc::c_int
                                                                  as
                                                                  libc::c_ulong)
                                          as isize) as libc::c_int ==
                       '<' as i32 ||
...
unsafe extern "C" fn ee_compare(mut ee: *mut expreval_t) {
    ...
    while (*ee).head < (*ee).len && (*ee).error == 0 &&
        ...
        (*ee).head =
            ((*ee).head as
                 libc::c_ulong).wrapping_add(if op > 2 as libc::c_int {
                                                 2 as libc::c_int
                        ...
                        match (*ee).type_0 {
                            1 => {
                                (*ee).ival =
                                    if odval < (*ee).dval {
                                        1 as libc::c_int
                                    } else { 0 as libc::c_int } as lilint_t;
                                (*ee).type_0 = 0 as libc::c_int
                            }
                            0 => {
                                (*ee).ival =
...
pub unsafe extern "C" fn lil_eval_expr(mut lil: lil_t, mut code: lil_value_t)
 -> lil_value_t {
    let mut ee: expreval_t =
        expreval_t{code: 0 as *const libc::c_char,
                   len: 0,
                   head: 0,
                   ival: 0,
                   dval: 0.,
...
pub unsafe extern "C" fn lil_unused_name(mut lil: lil_t,
 ...
 -> lil_value_t {
    ...
    while i < -(1 as libc::c_int) as size_t {
        sprintf(name,
                b"!!un!%s!%09u!nu!!\x00" as *const u8 as *const libc::c_char,
                part, i as libc::c_uint);
...
pub unsafe extern "C" fn lil_to_boolean(mut val: lil_value_t) -> libc::c_int {
    ...
    if *s.offset(0 as libc::c_int as isize) == 0 { return 0 as libc::c_int }
    i = 0 as libc::c_int as size_t;
    while *s.offset(i as isize) != 0 {
        ...
        if *s.offset(i as isize) as libc::c_int == '.' as i32 {
            if dots != 0 { return 1 as libc::c_int }
...
#[no_mangle]
pub unsafe extern "C" fn lil_alloc_string(mut str: *const libc::c_char)
 -> lil_value_t {
    return alloc_value(str);
}
#[no_mangle]
pub unsafe extern "C" fn lil_alloc_string_len(mut str: *const libc::c_char,
                                              mut len: size_t)
 -> lil_value_t {
    return alloc_value_len(str, len);
}
#[no_mangle]
pub unsafe extern "C" fn lil_alloc_double(mut num: libc::c_double)
 -> lil_value_t {
    let mut buff: [libc::c_char; 128] = [0; 128];
    sprintf(buff.as_mut_ptr(), b"%f\x00" as *const u8 as *const libc::c_char,
            num);
...
pub unsafe extern "C" fn lil_alloc_integer(mut num: lilint_t) -> lil_value_t {
    let mut buff: [libc::c_char; 128] = [0; 128];
    sprintf(buff.as_mut_ptr(), b"%li\x00" as *const u8 as *const libc::c_char,
            num);
    return alloc_value(buff.as_mut_ptr());
}
#[no_mangle]
...
unsafe extern "C" fn fnc_embed_write(mut lil: lil_t,
                                     mut msg: *const libc::c_char) {
    let mut len: size_t =
        strlen(msg).wrapping_add(1 as libc::c_int as libc::c_ulong);
    (*lil).embed =
        realloc((*lil).embed as *mut libc::c_void,
                (*lil).embedlen.wrapping_add(len)) as *mut libc::c_char;
    memcpy((*lil).embed.offset((*lil).embedlen as isize) as *mut libc::c_void,
           msg as *const libc::c_void, len);
    (*lil).embedlen =
        ((*lil).embedlen as
             libc::c_ulong).wrapping_add(len.wrapping_sub(1 as libc::c_int as
                                                              libc::c_ulong))
            as size_t as size_t;
}
#[no_mangle]
pub unsafe extern "C" fn lil_embedded(mut lil: lil_t,
 ...
 -> *mut libc::c_char {
    ...
    while head < codelen {
        if head < codelen.wrapping_sub(4 as libc::c_int as libc::c_ulong) &&
               *code.offset(head as isize) as libc::c_int == '<' as i32 &&
               *code.offset(head.wrapping_add(1 as libc::c_int as
                                                  libc::c_ulong) as isize) as
                   libc::c_int == '?' as i32 &&
               *code.offset(head.wrapping_add(2 as libc::c_int as
                                                  libc::c_ulong) as isize) as
                   libc::c_int == 'l' as i32 &&
               *code.offset(head.wrapping_add(3 as libc::c_int as
                                                  libc::c_ulong) as isize) as
                   libc::c_int == 'i' as i32 &&
               *code.offset(head.wrapping_add(4 as libc::c_int as
                                                  libc::c_ulong) as isize) as
                   libc::c_int == 'l' as i32 {
            head =
                (head as
            ...
            if contlen != 0 {
                lilcode =
                    realloc(lilcode as *mut libc::c_void,
                ...
                memcpy(lilcode.offset(lilcodelen as isize) as
                           *mut libc::c_void,
                       b"\nwrite {\x00" as *const u8 as *const libc::c_char as
                           *const libc::c_void,
                       8 as libc::c_int as libc::c_ulong);
                memcpy(lilcode.offset(lilcodelen as
                                          isize).offset(8 as libc::c_int as
                                                            isize) as
                           *mut libc::c_void, cont as *const libc::c_void,
                       contlen);
                ...
                *lilcode.offset(lilcodelen.wrapping_add(contlen).wrapping_add(9
                ...
                lilcodelen =
                    (lilcodelen as
                         libc::c_ulong).wrapping_add(contlen.wrapping_add(10
                                                                              as
                                                                              libc::c_int
                                                                              as
                                                                              libc::c_ulong))
            ...
            while head < codelen {
                if head <
                       codelen.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                       &&
                       *code.offset(head as isize) as libc::c_int ==
                           '?' as i32 &&
                       *code.offset(head.wrapping_add(1 as libc::c_int as
                                                          libc::c_ulong) as
                    ...
                    lilcode =
                        realloc(lilcode as *mut libc::c_void,
                                lilcodelen.wrapping_add(1 as libc::c_int as
                                                            libc::c_ulong)) as
                            *mut libc::c_char;
                    let fresh20 = head;
         ...
         {
            cont =
                realloc(cont as *mut libc::c_void,
                        contlen.wrapping_add(6 as libc::c_int as
                                                 libc::c_ulong)) as
                    *mut libc::c_char;
            let fresh23 = contlen;
            ...
            *cont.offset(fresh29 as isize) = '{' as i32 as libc::c_char;
            ...
            cont =
                realloc(cont as *mut libc::c_void,
                        contlen.wrapping_add(1 as libc::c_int as
                                                 libc::c_ulong)) as
                    *mut libc::c_char;
            let fresh30 = head;
            head = head.wrapping_add(1);
    ...
    if contlen != 0 {
        lilcode =
            realloc(lilcode as *mut libc::c_void,
                    lilcodelen.wrapping_add(contlen).wrapping_add(10 as
                                                                      ...
                                                                      libc::c_ulong))
                as *mut libc::c_char;
        memcpy(lilcode.offset(lilcodelen as isize) as *mut libc::c_void,
               b"\nwrite {\x00" as *const u8 as *const libc::c_char as
                   *const libc::c_void, 8 as libc::c_int as libc::c_ulong);
        memcpy(lilcode.offset(lilcodelen as
                                  isize).offset(8 as libc::c_int as isize) as
                   *mut libc::c_void, cont as *const libc::c_void, contlen);
        ...
        *lilcode.offset(lilcodelen.wrapping_add(contlen).wrapping_add(9 as
        ...
        lilcodelen =
            (lilcodelen as
                 libc::c_ulong).wrapping_add(contlen.wrapping_add(10 as
                                                                      libc::c_int
                                                                      as
                                                                      libc::c_ulong))
                as size_t as size_t;
    ...
    lilcode =
        realloc(lilcode as *mut libc::c_void,
                lilcodelen.wrapping_add(1 as libc::c_int as libc::c_ulong)) as
            *mut libc::c_char;
    *lilcode.offset(lilcodelen as isize) = 0 as libc::c_int as libc::c_char;
    lil_free_value(lil_parse(lil, lilcode, 0 as libc::c_int as size_t,
                             1 as libc::c_int));
    free(lilcode as *mut libc::c_void);
    result =
        if !(*lil).embed.is_null() {
            (*lil).embed
        } else { strclone(b"\x00" as *const u8 as *const libc::c_char) };
...
pub unsafe extern "C" fn lil_write(mut lil: lil_t,
    ...
    } else { printf(b"%s\x00" as *const u8 as *const libc::c_char, msg); };
}
unsafe extern "C" fn fnc_reflect(mut lil: lil_t, mut argc: size_t,
    ...
    if strcmp(type_0, b"version\x00" as *const u8 as *const libc::c_char) == 0
       {
        return lil_alloc_string(b"0.1\x00" as *const u8 as
                                    *const libc::c_char)
    }
    if strcmp(type_0, b"args\x00" as *const u8 as *const libc::c_char) == 0 {
    ...
    if strcmp(type_0, b"body\x00" as *const u8 as *const libc::c_char) == 0 {
        if argc < 2 as libc::c_int as libc::c_ulong {
            return 0 as lil_value_t
        }
        func =
    ...
    if strcmp(type_0, b"func-count\x00" as *const u8 as *const libc::c_char)
           == 0 {
        return lil_alloc_integer((*lil).cmds as lilint_t)
    }
    if strcmp(type_0, b"funcs\x00" as *const u8 as *const libc::c_char) == 0 {
    ...
    if strcmp(type_0, b"vars\x00" as *const u8 as *const libc::c_char) == 0 {
    ...
    if strcmp(type_0, b"globals\x00" as *const u8 as *const libc::c_char) == 0
       {
    ...
    if strcmp(type_0, b"has-func\x00" as *const u8 as *const libc::c_char) ==
           0 {
    ...
    if strcmp(type_0, b"has-var\x00" as *const u8 as *const libc::c_char) == 0
       {
    ...
    if strcmp(type_0, b"has-global\x00" as *const u8 as *const libc::c_char)
           == 0 {
    ...
    if strcmp(type_0, b"error\x00" as *const u8 as *const libc::c_char) == 0 {
        return if !(*lil).err_msg.is_null() {
                   lil_alloc_string((*lil).err_msg)
               } else { 0 as lil_value_t }
    }
    if strcmp(type_0,
              b"dollar-prefix\x00" as *const u8 as *const libc::c_char) == 0 {
    ...
    if strcmp(type_0, b"this\x00" as *const u8 as *const libc::c_char) == 0 {
    ...
    if strcmp(type_0, b"name\x00" as *const u8 as *const libc::c_char) == 0 {
...
unsafe extern "C" fn fnc_func(mut lil: lil_t, mut argc: size_t,
    ...
    if argc < 1 as libc::c_int as libc::c_ulong { return 0 as lil_value_t }
...
unsafe extern "C" fn fnc_rename(mut lil: lil_t, mut argc: size_t,
    ...
    if argc < 2 as libc::c_int as libc::c_ulong { return 0 as lil_value_t }
    ...
    if func.is_null() {
        let mut msg: *mut libc::c_char =
            malloc((24 as libc::c_int as
                        libc::c_ulong).wrapping_add(strlen(oldname))) as
                *mut libc::c_char;
        sprintf(msg,
                b"unknown function \'%s\'\x00" as *const u8 as
 ...
 -> lil_value_t {
    return lil_unused_name(lil,
                           if argc > 0 as libc::c_int as libc::c_ulong {
                               lil_to_string(*argv.offset(0 as libc::c_int as
                                                              isize))
                           } else {
...
unsafe extern "C" fn fnc_quote(mut lil: lil_t, mut argc: size_t,
    ...
    i = 0 as libc::c_int as size_t;
    while i < argc {
        if i != 0 { lil_append_char(r, ' ' as i32 as libc::c_char); }
...
unsafe extern "C" fn fnc_set(mut lil: lil_t, mut argc: size_t,
    ...
    if argc == 0 { return 0 as lil_value_t }
    if strcmp(lil_to_string(*argv.offset(0 as libc::c_int as isize)),
              b"global\x00" as *const u8 as *const libc::c_char) == 0 {
    ...
    while i < argc {
        ...
        var =
            lil_set_var(lil, lil_to_string(*argv.offset(i as isize)),
                        *argv.offset(i.wrapping_add(1 as libc::c_int as
                                                        libc::c_ulong) as
                                         isize), access);
        i =
            (i as
...
unsafe extern "C" fn fnc_write(mut lil: lil_t, mut argc: size_t,
    ...
    i = 0 as libc::c_int as size_t;
    while i < argc {
        if i != 0 { lil_append_char(msg, ' ' as i32 as libc::c_char); }
...
unsafe extern "C" fn fnc_eval(mut lil: lil_t, mut argc: size_t,
                              mut argv: *mut lil_value_t) -> lil_value_t {
    if argc == 1 as libc::c_int as libc::c_ulong {
        return lil_parse_value(lil, *argv.offset(0 as libc::c_int as isize),
                               0 as libc::c_int)
    }
    if argc > 1 as libc::c_int as libc::c_ulong {
        let mut val: lil_value_t = alloc_value(0 as *const libc::c_char);
...
unsafe extern "C" fn fnc_enveval(mut lil: lil_t, mut argc: size_t,
    ...
    if argc == 1 as libc::c_int as libc::c_ulong {
        ...
        varvalues =
            malloc((::std::mem::size_of::<lil_value_t>() as
                        libc::c_ulong).wrapping_mul(lil_list_size(invars))) as
                *mut lil_value_t;
        i = 0 as libc::c_int as size_t;
        ...
        } else { codeindex = 1 as libc::c_int }
    }
    lil_push_env(lil);
    if !invars.is_null() {
        i = 0 as libc::c_int as size_t;
        while i < lil_list_size(invars) {
            lil_set_var(lil, lil_to_string(lil_list_get(invars, i)),
                        *varvalues.offset(i as isize), 2 as libc::c_int);
    ...
    if !invars.is_null() || !outvars.is_null() {
        if !outvars.is_null() {
            varvalues =
                realloc(varvalues as *mut libc::c_void,
                        (::std::mem::size_of::<lil_value_t>() as
                             libc::c_ulong).wrapping_mul(lil_list_size(outvars)))
                    as *mut lil_value_t;
            i = 0 as libc::c_int as size_t;
        ...
        if !outvars.is_null() {
            ...
            while i < lil_list_size(outvars) {
                lil_set_var(lil, lil_to_string(lil_list_get(outvars, i)),
                            *varvalues.offset(i as isize), 1 as libc::c_int);
                lil_free_value(*varvalues.offset(i as isize));
                i = i.wrapping_add(1)
            }
        } else {
...
unsafe extern "C" fn fnc_jaileval(mut lil: lil_t, mut argc: size_t,
    ...
    if argc == 0 { return 0 as lil_value_t }
    if strcmp(lil_to_string(*argv.offset(0 as libc::c_int as isize)),
              b"clean\x00" as *const u8 as *const libc::c_char) == 0 {
...
unsafe extern "C" fn fnc_count(mut lil: lil_t, mut argc: size_t,
    ...
    if argc == 0 {
        return alloc_value(b"0\x00" as *const u8 as *const libc::c_char)
    }
    list = lil_subst_to_list(lil, *argv.offset(0 as libc::c_int as isize));
    sprintf(buff.as_mut_ptr(), b"%u\x00" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn fnc_indexof(mut lil: lil_t, mut argc: size_t,
    ...
    while index < (*list).c {
        if strcmp(lil_to_string(*(*list).v.offset(index as isize)),
                  lil_to_string(*argv.offset(1 as libc::c_int as isize))) == 0
           {
...
unsafe extern "C" fn fnc_append(mut lil: lil_t, mut argc: size_t,
    ...
    if strcmp(varname, b"global\x00" as *const u8 as *const libc::c_char) == 0
       {
        if argc < 3 as libc::c_int as libc::c_ulong {
            return 0 as lil_value_t
        }
...
unsafe extern "C" fn fnc_concat(mut lil: lil_t, mut argc: size_t,
    ...
    let mut i: size_t = 0;
    if argc < 1 as libc::c_int as libc::c_ulong { return 0 as lil_value_t }
    r = lil_alloc_string(b"\x00" as *const u8 as *const libc::c_char);
    i = 0 as libc::c_int as size_t;
    while i < argc {
...
unsafe extern "C" fn fnc_return(mut lil: lil_t, mut argc: size_t,
    ...
    (*(*lil).env).retval =
        if argc < 1 as libc::c_int as libc::c_ulong {
            0 as lil_value_t
        } else { lil_clone_value(*argv.offset(0 as libc::c_int as isize)) };
...
unsafe extern "C" fn real_inc(mut lil: lil_t,
                              ...
                              mut v: libc::c_float) -> lil_value_t {
...
unsafe extern "C" fn fnc_inc(mut lil: lil_t, mut argc: size_t,
    ...
    return real_inc(lil,
                    ...
                    } else { 1 as libc::c_int as libc::c_double } as
                        libc::c_float);
}
unsafe extern "C" fn fnc_dec(mut lil: lil_t, mut argc: size_t,
    ...
    return real_inc(lil,
                    lil_to_string(*argv.offset(0 as libc::c_int as isize)),
                    -if argc > 1 as libc::c_int as libc::c_ulong {
                         lil_to_double(*argv.offset(1 as libc::c_int as
                                                        isize))
                     } else { 1 as libc::c_int as libc::c_double } as
                        libc::c_float);
}
unsafe extern "C" fn fnc_read(mut lil: lil_t, mut argc: size_t,
    ...
    if (*lil).callback[2 as libc::c_int as usize].is_some() {
        ...
        f =
            fopen(lil_to_string(*argv.offset(0 as libc::c_int as isize)),
        ...
        buffer =
            malloc(size.wrapping_add(1 as libc::c_int as libc::c_ulong)) as
                *mut libc::c_char;
        fread(buffer as *mut libc::c_void, 1 as libc::c_int as size_t, size,
              f);
...
unsafe extern "C" fn fnc_store(mut lil: lil_t, mut argc: size_t,
    ...
    if (*lil).callback[3 as libc::c_int as usize].is_some() {
        ...
        fwrite(buffer as *const libc::c_void, 1 as libc::c_int as size_t,
               strlen(buffer), f);
        fclose(f);
    }
...
unsafe extern "C" fn fnc_if(mut lil: lil_t, mut argc: size_t,
    ...
    if argc < 1 as libc::c_int as libc::c_ulong { return 0 as lil_value_t }
    if strcmp(lil_to_string(*argv.offset(0 as libc::c_int as isize)),
              b"not\x00" as *const u8 as *const libc::c_char) == 0 {
        not = 1 as libc::c_int;
        base = not
    }
    ...
    if v != 0 {
        r =
            lil_parse_value(lil,
                  ...
                  (base as
                       size_t).wrapping_add(2 as libc::c_int as libc::c_ulong)
     {
        r =
            lil_parse_value(lil,
...
unsafe extern "C" fn fnc_while(mut lil: lil_t, mut argc: size_t,
    ...
    while (*lil).error == 0 && (*(*lil).env).breakrun == 0 {
        ...
        if v == 0 {
            ...
            r =
                lil_parse_value(lil,
                                *argv.offset((base + 1 as libc::c_int) as
...
unsafe extern "C" fn fnc_for(mut lil: lil_t, mut argc: size_t,
    ...
    let mut val: lil_value_t = 0 as *mut _lil_value_t;
    let mut r: lil_value_t = 0 as lil_value_t;
    if argc < 4 as libc::c_int as libc::c_ulong { return 0 as lil_value_t }
    ...
    while (*lil).error == 0 && (*(*lil).env).breakrun == 0 {
        ...
        if lil_to_boolean(val) == 0 {
            ...
            if !r.is_null() { lil_free_value(r); }
            r =
                lil_parse_value(lil, *argv.offset(3 as libc::c_int as isize),
                                0 as libc::c_int);
            lil_free_value(val);
            lil_free_value(lil_parse_value(lil,
...
unsafe extern "C" fn fnc_char(mut lil: lil_t, mut argc: size_t,
    ...
    s[0 as libc::c_int as usize] =
        lil_to_integer(*argv.offset(0 as libc::c_int as isize)) as
            libc::c_char;
...
unsafe extern "C" fn fnc_substr(mut lil: lil_t, mut argc: size_t,
    ...
    if argc < 2 as libc::c_int as libc::c_ulong { return 0 as lil_value_t }
    str = lil_to_string(*argv.offset(0 as libc::c_int as isize));
    if *str.offset(0 as libc::c_int as isize) == 0 { return 0 as lil_value_t }
    slen = strlen(str);
    start =
        atoll(lil_to_string(*argv.offset(1 as libc::c_int as isize))) as
            size_t;
    end =
        if argc > 2 as libc::c_int as libc::c_ulong {
            atoll(lil_to_string(*argv.offset(2 as libc::c_int as isize))) as
                size_t
        } else { slen };
...
unsafe extern "C" fn fnc_strpos(mut lil: lil_t, mut argc: size_t,
    ...
    return lil_alloc_integer(str.wrapping_offset_from(hay) as libc::c_long);
}
unsafe extern "C" fn fnc_length(mut lil: lil_t, mut argc: size_t,
    ...
    while i < argc {
        ...
        total =
            (total as
                 libc::c_ulong).wrapping_add(strlen(lil_to_string(*argv.offset(i
                                                                                   as
                                                                                   isize))))
                as size_t as size_t;
        i = i.wrapping_add(1)
...
unsafe extern "C" fn real_trim(mut str: *const libc::c_char,
 ...
 -> lil_value_t {
    ...
    if left != 0 {
        while *str.offset(base as isize) as libc::c_int != 0 &&
                  !strchr(chars,
                          *str.offset(base as isize) as libc::c_int).is_null()
              {
            base += 1
        }
        if right == 0 {
            r =
                lil_alloc_string(if *str.offset(base as isize) as libc::c_int
                                        != 0 {
    ...
    if right != 0 {
        ...
        while len != 0 &&
                  !strchr(chars,
                          *s.offset(len.wrapping_sub(1 as libc::c_int as
                                                         libc::c_ulong) as
                                        isize) as libc::c_int).is_null() {
...
unsafe extern "C" fn fnc_trim(mut lil: lil_t, mut argc: size_t,
                              mut argv: *mut lil_value_t) -> lil_value_t {
    if argc == 0 { return 0 as lil_value_t }
    return real_trim(lil_to_string(*argv.offset(0 as libc::c_int as isize)),
                     if argc < 2 as libc::c_int as libc::c_ulong {
                         b" \x0c\n\r\t\x0b\x00" as *const u8 as
                             *const libc::c_char
                     } else {
                         lil_to_string(*argv.offset(1 as libc::c_int as
                                                        isize))
...
unsafe extern "C" fn fnc_streq(mut lil: lil_t, mut argc: size_t,
    ...
    return lil_alloc_integer(if strcmp(lil_to_string(*argv.offset(0 as
                                    ...
                                    != 0 {
                                 0 as libc::c_int
                             } else { 1 as libc::c_int } as lilint_t);
}
unsafe extern "C" fn fnc_repstr(mut lil: lil_t, mut argc: size_t,
    ...
    loop  {
        ...
        let mut newsrc: *mut libc::c_char =
            malloc(srclen.wrapping_sub(fromlen).wrapping_add(tolen).wrapping_add(1
                                                                                     ...
                                                                                     libc::c_ulong))
                as *mut libc::c_char;
        idx = sub.wrapping_offset_from(src) as libc::c_long as size_t;
        if idx != 0 {
            memcpy(newsrc as *mut libc::c_void, src as *const libc::c_void,
                   idx);
        }
        memcpy(newsrc.offset(idx as isize) as *mut libc::c_void,
               to as *const libc::c_void, tolen);
...
unsafe extern "C" fn fnc_split(mut lil: lil_t, mut argc: size_t,
    ...
    let mut val: lil_value_t = 0 as *mut _lil_value_t;
    let mut str: *const libc::c_char = 0 as *const libc::c_char;
    if argc == 0 as libc::c_int as libc::c_ulong { return 0 as lil_value_t }
    if argc > 1 as libc::c_int as libc::c_ulong {
    ...
    val = lil_alloc_string(b"\x00" as *const u8 as *const libc::c_char);
    str = lil_to_string(*argv.offset(0 as libc::c_int as isize));
    list = lil_alloc_list();
    i = 0 as libc::c_int as size_t;
    while *str.offset(i as isize) != 0 {
        if !strchr(sep, *str.offset(i as isize) as libc::c_int).is_null() {
            ...
            val =
                lil_alloc_string(b"\x00" as *const u8 as *const libc::c_char)
...
unsafe extern "C" fn fnc_try(mut lil: lil_t, mut argc: size_t,
    ...
    if (*lil).error != 0 { return 0 as lil_value_t }
    r =
        lil_parse_value(lil, *argv.offset(0 as libc::c_int as isize),
                        0 as libc::c_int);
    if (*lil).error != 0 {
        (*lil).error = 0 as libc::c_int;
        lil_free_value(r);
        if argc > 1 as libc::c_int as libc::c_ulong {
            r =
                lil_parse_value(lil, *argv.offset(1 as libc::c_int as isize),
                                0 as libc::c_int)
...
unsafe extern "C" fn fnc_rand(mut lil: lil_t, mut argc: size_t,
                              mut argv: *mut lil_value_t) -> lil_value_t {
    return lil_alloc_double(rand() as libc::c_double /
...
unsafe extern "C" fn fnc_watch(mut lil: lil_t, mut argc: size_t,
    ...
    if argc < 2 as libc::c_int as libc::c_ulong { return 0 as lil_value_t }
    wcode =
        lil_to_string(*argv.offset(argc.wrapping_sub(1 as libc::c_int as
                                                         libc::c_ulong) as
                                       isize));
    i = 0 as libc::c_int as size_t;
    while i.wrapping_add(1 as libc::c_int as libc::c_ulong) < argc {
        let mut vname: *const libc::c_char =
            lil_to_string(*argv.offset(i as isize));
        ...
        if !(*vname.offset(0 as libc::c_int as isize) == 0) {
            ...
            (*v).w =
                if *wcode.offset(0 as libc::c_int as isize) as libc::c_int !=
                       0 {
                    strclone(wcode)
                } else { 0 as *mut libc::c_char }
        }
...
unsafe extern "C" fn register_stdcmds(mut lil: lil_t) {
    lil_register(lil, b"reflect\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_reflect as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"func\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_func as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"rename\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_rename as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"unusedname\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_unusedname as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"quote\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_quote as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"set\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_set as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"local\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_local as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"write\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_write as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"print\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_print as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"eval\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_eval as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"topeval\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_topeval as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"upeval\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_upeval as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"downeval\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_downeval as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"enveval\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_enveval as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"jaileval\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_jaileval as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"count\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_count as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"index\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_index as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"indexof\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_indexof as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"filter\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_filter as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"list\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_list as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"append\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_append as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"slice\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_slice as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"subst\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_subst as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"concat\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_concat as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"foreach\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_foreach as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"return\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_return as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"result\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_result as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"expr\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_expr as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"inc\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_inc as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"dec\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_dec as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"read\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_read as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"store\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_store as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"if\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_if as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"while\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_while as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"for\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_for as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"char\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_char as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"charat\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_charat as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"codeat\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_codeat as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"substr\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_substr as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"strpos\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_strpos as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"length\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_length as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"trim\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_trim as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"ltrim\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_ltrim as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"rtrim\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_rtrim as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"strcmp\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_strcmp as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"streq\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_streq as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"repstr\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_repstr as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"split\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_split as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"try\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_try as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"error\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_error as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"exit\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_exit as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"source\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_source as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"lmap\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_lmap as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"rand\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_rand as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"catcher\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_catcher as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
    lil_register(lil, b"watch\x00" as *const u8 as *const libc::c_char,
                 Some(fnc_watch as
                          unsafe extern "C" fn(_: lil_t, _: size_t,
                                               _: *mut lil_value_t)
                              -> lil_value_t));
